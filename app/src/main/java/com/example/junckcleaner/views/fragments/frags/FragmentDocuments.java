...
public class FragmentDocuments extends Fragment implements DuplicateListener {
    ...
    private void initDocuments() {
        ...
        activity.getWindow().setStatusBarColor(ContextCompat.getColor(context, R.color.color_maroon_flush_1));
    ...
    private void deleteDuplicate() {
        if (Constants.fileToBeDeleted.size() <= 0) {
            Functions.showToastMsg(getActivity(), getString(R.string.least_one_documents));
