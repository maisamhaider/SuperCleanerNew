...
public class FragmentVideos extends Fragment implements DuplicateListener {
    ...
    public void initVideoUi() {
        ...
        textView_not_found = view.findViewById(R.id.textView_video_not_found);
        ...
        getActivity().getWindow().setStatusBarColor(ContextCompat.getColor(getActivity(), R.color.color_cerulean_2));
    ...
    private void deleteDuplicate() {
        if (Constants.fileToBeDeleted.size() <= 0) {
            Functions.showToastMsg(getActivity(), getString(R.string.least_one_video));
