...
public class JunkAdapter3 extends ListAdapter<String, JunkAdapter3.FileHolder> {
    Context context;
    Utils utils;
    View view;
    FileHolder holder;
    ...
    public JunkAdapter3(Context context, List<String> killingApps, List<String> adapterApps) {
        super(DIFF_CALLBACK);
    ...
    public void onBindViewHolder(@NonNull FileHolder holder, int position) {
        ...
        holder.textView_size.setText(utils.getDataSizeWithPrefix((float) utils.getCache(getItem(position))));
