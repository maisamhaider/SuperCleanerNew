...
public class JunkAdapter2 extends ListAdapter<String, JunkAdapter2.FileHolder> {
    Context context;
    Utils utils;
    View view;
    FileHolder holder;
    ...
    public JunkAdapter2(Context context, List<String> killingApps, List<String> adapterApps) {
        super(DIFF_CALLBACK);
